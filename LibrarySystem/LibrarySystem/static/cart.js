const items = [
    { id: 1, name: 'Control back', price: 5.99, quantity: 0 },
    { id: 2, name: 'Brain treaser', price: 8.99, quantity: 0 },
    { id: 3, name: 'hello-world', price: 3.49, quantity: 0 },
    { id: 4, name: 'world up', price: 4.99, quantity: 0 }
  ];
